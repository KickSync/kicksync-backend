...
public class SettlementJobConfig {
    ...
    public JpaPagingItemReader<PartnerSettlementDto> settlementItemReader(
        ...
        List<OrderStatus> settleableStatuses = List.of(OrderStatus.PURCHASE_CONFIRMED);
        parameters.put("settleableStatuses", settleableStatuses);
        ...
        queryStringBuilder.append("WHERE o.orderDate BETWEEN :startDate AND :endDate ");
        queryStringBuilder.append("AND o.status IN :settleableStatuses ");
