...
<img width="1252" height="1832" alt="image" src="https://github.com/user-attachments/assets/9bcb75b2-59d6-441d-93be-3c14a95fb5cb" />
...
* **문제 상황 AS-IS**
  ...
  * 외부 결제 API DB 트랜잭션 강결합 에 따른 커넥션 풀 전면 고갈 리스크 ➔ 인증 필터 조회 타임아웃 연쇄 장애 및 가용성 0.00% 하락
  ...
  <br>
    ...
    <img width="1371" height="1191" alt="image" src="https://github.com/user-attachments/assets/7dd18b56-a832-4c51-99b6-5b9cc9b1481a" />
    <img width="1682" height="1541" alt="image" src="https://github.com/user-attachments/assets/1c1e0e75-6e1c-415c-bdf8-1cc532517633" />
...
* 배포 자동화 ➔ GitHub Actions 연동 main 브랜치 푸시 시 빌드 및 OCI 인스턴스 자동 배포 파이프라인 확보
